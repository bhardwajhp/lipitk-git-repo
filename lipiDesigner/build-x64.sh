...
if [ "$build" = yes ]; then
	...
	make -f $LIPITK_DESIGNER/src/lipijniinterface/linux-x64/Makefile.linux  1> $LIPITK_DESIGNER/build.log 2>&1
	...
	make -f $LIPITK_DESIGNER/src/lipijniinterface/linux-x64/Makefile.linux clean 1> $LIPITK_DESIGNER/build.log 2>&1
